# uni training
# CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node=8 --master_port=3222  --use_env grounding_cvta.py \
#     --config configs/grounding_cvta_large.yaml \
#     --dataset vg_uni \
