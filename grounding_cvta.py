...
from models.model_grounding_cvta import CVTA
...
def main(args, config):
    ...
    model = CVTA(config = config, text_encoder=args.text_encoder, text_decoder=args.text_decoder, tokenizer=tokenizer)
